...
rem call Pug .\pug\tricks\personal\05-create-a-personal-development-plan.pug --pretty --out ..\live\tricks\personal
rem call Pug .\pug\tricks\personal\06-learn-to-manage-your-time-well.pug --pretty --out ..\live\tricks\personal
